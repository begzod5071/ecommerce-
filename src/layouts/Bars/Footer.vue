...
<template>
  <div class="bg-[#008ECC] ">
    <div class="max-w-screen-xl mx-4 lg:mx-auto">
      <div class="py-[80px] flex">
        <div class="mr-[180px]">
          <button class="mb-[34px]">
            <img src="@/assets/icons/logo-white.svg" alt="" />
          </button>

          <div>
            <span class="text-white font-bold block mb-[20px]">Contact Us</span>

            <div class="flex gap-2 mb-[20px]">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
              ...
              <div>
                <span class="block text-white">Whats App</span>
                <span class="block text-white">+1 202-918-2132</span>
              </div>
            </div>
            ...
            <div class="flex gap-2 mb-[30px]">
              ...
              <div>
                <span class="block text-white">Call Us</span>
                <span class="block text-white">+1 202-918-2132</span>
              </div>
            </div>

            <div>
              <span class="text-white font-bold block mb-[20px] text-[20px]"
                >Download App</span
              >
        ...
        <div class="mr-[150px]">
          <span
            class="block relative text-white font-semibold text-[18px] before:contents-[''] before:w-full before:h-[3px] before:bg-[#fff] before:block before:absolute before:bottom-[-16px] before:left-0 before:rounded-2xl"
            >Eng mashhur toifalar</span
          >

          <ul style="list-style: circle" class="mt-12 ml-8">
            <li class="text-white mb-4">Zımbalar</li>
            <li class="text-white mb-4">Ichimliklar</li>
            <li class="text-white mb-4">Shaxsiy parvarish</li>
            <li class="text-white mb-4">Uyda parvarishlash</li>
            <li class="text-white mb-4">Chaqaloq parvarishi</li>
            <li class="text-white mb-4">Sabzavotlar va mevalar</li>
            <li class="text-white mb-4">Aperatiflar va ovqatlar</li>
            <li class="text-white mb-4">Sut va non mahsulotlari</li>
          </ul>
        </div>
        ...
        <div>
          <span
            class="block relative text-white font-semibold text-[18px] before:contents-[''] before:w-full before:h-[3px] before:bg-[#fff] before:block before:absolute before:bottom-[-16px] before:left-0 before:rounded-2xl"
            >Mijozlarga xizmat ko'rsatish</span
          >

          <ul style="list-style: circle" class="mt-12 ml-8">
            <li class="text-white mb-4">Biz haqimizda</li>
            <li class="text-white mb-4">Foydalanish shartlari</li>
            <li class="text-white mb-4">FAQ</li>
            <li class="text-white mb-4">Maxfiylik siyosati</li>
            <li class="text-white mb-4">Elektron chiqindilar siyosati</li>
            <li class="text-white mb-4">Bekor qilish va qaytarish siyosati</li>
          </ul>
        </div>
      </div>

      <span class="block w-full h-[2px] bg-[#05ABF3] mb-[30px]"></span>

      <span class="block text-center text-white text-[18px] pb-[30px]">© 2022 All rights reserved. Reliance Retail Ltd.</span>
    </div>
  </div>
</template>
